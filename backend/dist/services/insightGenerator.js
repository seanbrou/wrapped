...
let modelAvailabilityPromise = null;
function buildTemplateCopy(stats) {
    const copy = {};
...
export async function warmAiGateway(logger = console) {
...
export async function generateAIInsights(stats, periodLabel) {
