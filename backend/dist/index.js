...
async function sendPrivacyPage(reply) {
    return reply.type('text/html').send(legalPage('Wrapped Privacy Policy', `
...
async function sendTermsPage(reply) {
    reply.type('text/html').send(legalPage('Wrapped Terms of Service', `
...
async function sendSupportPage(reply) {
    reply.type('text/html').send(legalPage('Wrapped Support', `
      <h1>Support</h1>
