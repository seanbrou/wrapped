...
export const SERVICE_CONFIGS: ServiceConfig[] = [
  ...
  },
  {
    id: 'trakt',
    name: 'Trakt',
    tagline: 'TV shows and movies watched',
    signal: 'Episodes & films',
    mark: 'T',
    color: colors.trakt,
    accentKey: 'red',
    logoUri: 'https://www.google.com/s2/favicons?domain=trakt.tv&sz=256',
    authKind: 'oauth2',
  },
  {
    id: 'reddit',
    name: 'Reddit',
    tagline: 'Subreddit karma and communities',
    signal: 'Upvotes & comments',
    mark: 'R',
    color: colors.reddit,
    accentKey: 'coral',
    logoUri: 'https://www.google.com/s2/favicons?domain=reddit.com&sz=256',
    authKind: 'oauth2',
  },
  {
    id: 'rescuetime',
    name: 'RescueTime',
    tagline: 'Screen time and productivity',
    signal: 'Productive hours',
    mark: 'R',
    color: colors.rescuetime,
    accentKey: 'sky',
    logoUri: 'https://www.google.com/s2/favicons?domain=rescuetime.com&sz=256',
    authKind: 'oauth2',
  },
  {
    id: 'todoist',
    name: 'Todoist',
    tagline: 'Tasks completed and streaks',
    signal: 'Tasks done',
    mark: 'T',
    color: colors.todoist,
    accentKey: 'red',
    logoUri: 'https://www.google.com/s2/favicons?domain=todoist.com&sz=256',
    authKind: 'oauth2',
  },
];
